...
for (k=0; k < runs.length; k++)	{
	...
	//				run("Remove Outliers...", "radius=2 threshold=50 which=Bright");
					...
					if(newPanel) {
						...
						if(max < panck_threshold || imgName == 'P1_TMA006_R_20190619-roi_19' ||
            	            ...
            	            imgName == 'P1_TMA001_L_20190508-roi_5' || imgName == 'P1_TMA001_L_20190508-roi_19' || imgName == 'P1_TMA_REC_20190508-roi_7' || imgName == 'P1_TMA003_L_20190619_correct-roi_4' ) {
